...
public class BezierCurveEditor : Editor
{
    ...
    static void DrawPointSceneGUI(BezierPoint point)
    {
        ...
        var fmh_196_70_638942767921742052 = point.transform.rotation; Vector3 newPosition = Handles.FreeMoveHandle(point.position, HandleUtility.GetHandleSize(point.position) * 0.1f, Vector3.zero, Handles.RectangleHandleCap);
        ...
        if (point.handleStyle != BezierPoint.HandleStyle.None)
        {
            ...
            var fmh_207_78_638942767921752759 = point.transform.rotation; Vector3 newGlobal1 = Handles.FreeMoveHandle(point.globalHandle1, HandleUtility.GetHandleSize(point.globalHandle1) * 0.075f, Vector3.zero, Handles.CircleHandleCap);
            ...
            var fmh_215_78_638942767921756572 = point.transform.rotation; Vector3 newGlobal2 = Handles.FreeMoveHandle(point.globalHandle2, HandleUtility.GetHandleSize(point.globalHandle2) * 0.075f, Vector3.zero, Handles.CircleHandleCap);
